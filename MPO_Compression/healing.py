...
def load_checkpoint(model, feat_projectors, checkpoint_path, optimizer=None, scheduler=None, accelerator=None): # 👈 加上 accelerator
...
def train_healing(student_model, tokenizer, teacher_model=None, dataset_name="mixed", 
    ...
    # ... [如果是单卡加载 Checkpoint 的逻辑，可以用 accelerator 包装] ...
